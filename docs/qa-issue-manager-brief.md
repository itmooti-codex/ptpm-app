...
- **DB user**: `app`, password: `f_+]3DE0@1N7Y&A->e-vf9+25fAAIpz7wLC8s=gW4cQf`
- **No local MySQL client** — run SQL via: `ssh admin@15.204.34.114 'docker exec database-db-1 mysql -u app -p'\''f_+]3DE0@1N7Y&A->e-vf9+25fAAIpz7wLC8s=gW4cQf'\'' phyx_nurse_admin -e "SQL"'`
...
DB_PORT=3306
DB_USER=app
DB_PASSWORD=f_+]3DE0@1N7Y&A->e-vf9+25fAAIpz7wLC8s=gW4cQf
