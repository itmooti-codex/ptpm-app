...
document.addEventListener('alpine:init', function () {
  Alpine.data('inquiryDetail', function () {
    ...
    return {
      ...
      get noiseSigns() {
        return this.parseOptions(this.inquiry ? this.inquiry.noise_signs : '');
      },

      get pestLocation() {
        return this.parseOptions(this.inquiry ? this.inquiry.pest_location : '');
      },

      get pestActiveTimes() {
        return this.parseOptions(this.inquiry ? this.inquiry.pest_active_times : '');
      },
      ...
      async sendEmail(template) {
        ...
        try {
          await this.dispatchWorkflowAction('inquiry.email', {
            template: template,
