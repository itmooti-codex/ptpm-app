...
(function () {
  ...
  var ENUMS = {
    ...
    inquiry_source: ['Web Form', 'Phone Call', 'Email', 'SMS'],
    how_did_you_hear: ['Google', 'Bing', 'Facebook', 'Yellow Pages', 'Referral', 'Car Signage', 'Returning Customers', 'Other'],
    service_type_deal: [
      'Possum Roof',
      'Rat Roof',
      'Wasp Removal',
